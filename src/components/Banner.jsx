      ...
      <div className='flex w-full justify-center items-center'>
        <div className="mt-6 w-2/3 space-y-4 ms-10">
          ...
          <div className="icon-container flex space-x-6">
            <a 
              className="bg-black hover:bg-white cursor-pointer p-2 w-10 h-10 rounded-full flex items-center justify-center" 
            ...
            <a 
              className="bg-black hover:bg-white cursor-pointer p-2 w-10 h-10 rounded-full flex items-center justify-center" 
              href="https://x.com/ratnakarspeeks" 
              target="_blank" 
              rel="noopener noreferrer"
            >
            ...
            <a 
              className="bg-black hover:bg-white cursor-pointer p-2 w-10 h-10 rounded-full flex items-center justify-center" 
              href="https://github.com/ratn7921" 
              target="_blank" 
              rel="noopener noreferrer"
            >
            ...
            <a 
              className="bg-black hover:bg-white cursor-pointer p-2 w-10 h-10 rounded-full flex items-center justify-center" 
              href="https://www.instagram.com/ratnakar_14?igsh=MXU0MTQ2MHU2NWcyZA==" 
              target="_blank" 
              rel="noopener noreferrer"
            >
